...
class StudyPlanService
{
    ...
    private function createPlan(int $userId,array $requestData,array $planData,Carbon $startDate): StudyPlan{
    ...
    private function attachBooks(StudyPlan $studyPlan,array $bookIds): void {
        ...
        $studyPlan->books()->createMany($books);
    }
